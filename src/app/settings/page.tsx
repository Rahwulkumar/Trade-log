      ...
      <Tabs defaultValue="profile" className="space-y-6">
        ...
        <TabsContent value="profile" className="space-y-6">
          <div className="card-void p-6">
            ...
            <div className="flex items-center gap-6 mb-6">
              <Avatar className="h-20 w-20">
                ...
                <AvatarFallback className="text-2xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white">TR</AvatarFallback>
              </Avatar>
              <div className="space-y-2">
                <button className="btn-void text-sm">Change Photo</button>
            ...
            <div className="grid gap-4 md:grid-cols-2 mb-4">
              <div className="space-y-2">
                ...
                <Input id="firstName" defaultValue="Trader" className="bg-void border-white/10" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="lastName">Last Name</Label>
                <Input id="lastName" defaultValue="Pro" className="bg-void border-white/10" />
              </div>
            </div>

            <div className="space-y-2 mb-4">
              <Label htmlFor="email">Email</Label>
              <Input id="email" type="email" defaultValue="trader@example.com" className="bg-void border-white/10" />
            </div>
          ...
          <div className="card-void p-6">
            ...
            <p className="text-sm text-muted-foreground mb-6">Update your password</p>
            
            <div className="space-y-2 mb-4">
              <Label htmlFor="currentPassword">Current Password</Label>
              <Input id="currentPassword" type="password" className="bg-void border-white/10" />
            </div>
            <div className="grid gap-4 md:grid-cols-2 mb-6">
              <div className="space-y-2">
                <Label htmlFor="newPassword">New Password</Label>
                <Input id="newPassword" type="password" className="bg-void border-white/10" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="confirmPassword">Confirm Password</Label>
                <Input id="confirmPassword" type="password" className="bg-void border-white/10" />
              </div>
            </div>
            <button className="btn-void">Update Password</button>
          </div>
        </TabsContent>
        ...
        <TabsContent value="appearance" className="space-y-6">
              ...
              {[
                ...
                <button
                  ...
                  className={cn(
                    ...
                    theme === value ? "border-blue-500 bg-blue-500/10" : "border-white/10 hover:border-white/20"
                  )}
                >
          ...
          <div className="card-void p-6">
            ...
            <p className="text-sm text-muted-foreground mb-6">Default view mode for your dashboard</p>
          ...
          <div className="card-void p-6">
            ...
            <div className="space-y-6">
              {[
                ...
                { key: "drawdownAlert", label: "Drawdown Alerts", desc: "Alert when approaching drawdown limits" },
              ].map(({ key, label, desc }) => (
        ...
        <TabsContent value="trading" className="space-y-6">
          <div className="card-void p-6">
            ...
            <p className="text-sm text-muted-foreground mb-6">Configure your default trade settings</p>
            
            <div className="grid gap-4 md:grid-cols-2 mb-4">
              <div className="space-y-2">
                <Label>Default Risk %</Label>
                <Input type="number" defaultValue="1" step="0.1" className="bg-void border-white/10" />
              </div>
              <div className="space-y-2">
                <Label>Default R:R Ratio</Label>
                <Input type="number" defaultValue="2" step="0.5" className="bg-void border-white/10" />
              </div>
            </div>
            <div className="space-y-2 mb-6">
        ...
        <TabsContent value="data" className="space-y-6">
          <div className="card-void p-6">
            ...
            <p className="text-sm text-muted-foreground mb-6">Download your trading data</p>
          ...
          <div className="card-void p-6 border-red-500/20">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-lg bg-red-500/5 border border-red-500/10">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Permanently delete all your trade data</p>
                </div>
                <button className="btn-void border-red-500/20 text-red-500 hover:bg-red-500/10">
