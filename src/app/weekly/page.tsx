...
export default function WeeklyAnalysisPage() {
  const [currentWeek] = useState("Dec 16-20, 2024");
          ...
          <div className="grid gap-6 md:grid-cols-1">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your trading plan for this week
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Textarea
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Post-week reflection and analysis
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Textarea
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-gradient-to-br from-[#7c8bb8]/10 to-[#c9b89a]/10 border border-[#7c8bb8]/20">
                <div className="text-center">
                  <div
                    className={cn(
                      "text-3xl font-bold",
                      weeklyPerformance.netPnL >= 0
                        ? "text-[#7c8bb8]"
                        : "text-red-500",
                    )}
                  >
                    {weeklyPerformance.netPnL >= 0 ? "+" : ""}$
                    {weeklyPerformance.netPnL.toLocaleString()}
                  </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-[#7c8bb8]">
                  {weeklyPerformance.winners}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-[#7c8bb8]">
                    {weeklyPerformance.bestTrade.symbol} (+$
                    {weeklyPerformance.bestTrade.pnl})
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Worst Trade</span>
                  <span className="text-red-500">
                    {weeklyPerformance.worstTrade.symbol} ($
                    {weeklyPerformance.worstTrade.pnl})
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                {weeklyPerformance.byAsset.map((item) => (
                  ...
                  >
                    ...
                    <span
                      className={
                        item.pnl >= 0 ? "text-[#7c8bb8]" : "text-red-500"
                      }
                    >
                      ${item.pnl}
                    </span>
