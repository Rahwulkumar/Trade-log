...
import { PropFirm, PropFirmChallenge } from "@/lib/types/prop-firms";
import {
  getPropFirms,
  getFirmChallenges,
  upsertChallenge,
...
export function PropFirmManager() {
  ...
  }, [selectedFirmId]); // Dependency on selectedFirmId to ensure it's updated if firms are loaded before it's set
  ...
  const handleChallengeChange = (
    index: number,
    field: keyof PropFirmChallenge,
    value: PropFirmChallenge[keyof PropFirmChallenge],
  ) => {
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        <div className="w-[300px]">
          <Label htmlFor="firm-select" className="mb-2 block">
            Select Firm
          </Label>
          <Select
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-6">
            {challenges.map((challenge, index) => (
              <Card
                key={challenge.id}
                className="bg-black/60 backdrop-blur-xl border-white/5"
              >
                <CardContent className="p-6 space-y-4">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleChallengeChange(index, "name", e.target.value)
                        }
                      />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(v) =>
                          handleChallengeChange(index, "drawdown_type", v)
                        }
                      >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="space-y-2 flex items-end">
                      <Button
                        variant="outline"
                        className="bg-transparent border-white/10 hover:bg-white/5 w-full justify-center"
                        disabled={saving}
                  ...
                  <div className="pt-2 border-t border-white/5">
                    <details className="text-sm">
                      <summary className="cursor-pointer text-muted-foreground hover:text-white">
                        Advanced Rules (Fixed Amounts / Trailing)
                      </summary>
