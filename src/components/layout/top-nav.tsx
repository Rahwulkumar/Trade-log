...
import { Plus, Sun, Moon, Hexagon, Building2, Settings, Briefcase } from "lucide-react";
...
export function TopNav() {
  ...
  const { selectedAccountId, setSelectedAccountId, propAccounts, loading } = usePropAccount();
      ...
      >
        ...
        <div className="flex items-center gap-2 pr-1">
          ...
          >
            ...
            {/* Content */}
            <Plus className="w-3.5 h-3.5 text-gray-900 dark:text-white relative z-10 group-hover:rotate-90 transition-transform duration-300" strokeWidth={3} />
